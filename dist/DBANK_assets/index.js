...
//   if ( typeof (document.getElementById("input-amount").value) == "number" && document.getElementById("input-amount").value.length > 0){
//     await DBANK.topUp(inputAmount);
//   } 

//   if ( typeof (document.getElementById("withdrawal-amount").value) == "number" && document.getElementById("withdrawal-amount").value.length > 0){
